...
const firebaseConfig = {
  apiKey:
    ...
    "AIzaSyAX17XUOiLQSCszTg6DnHpnWSnelYYkQes",
  authDomain:
    process.env.NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN ||
    "llb-case-tracker.firebaseapp.com",
  databaseURL:
  ...
  storageBucket:
    ...
    "llb-case-tracker.firebasestorage.app",
  messagingSenderId:
    process.env.NEXT_PUBLIC_FIREBASE_MESSAGING_SENDER_ID || "539879699050",
  appId:
    process.env.NEXT_PUBLIC_FIREBASE_APP_ID ||
    "1:539879699050:web:c5dbc51ec4841fe77c9013",
  measurementId:
    process.env.NEXT_PUBLIC_FIREBASE_MEASUREMENT_ID || "G-NX3EN6M8EL",
};
...
if (
  ...
  console.error(
    "❌ Firebase API key is missing or invalid. Please set NEXT_PUBLIC_FIREBASE_API_KEY in .env.local"
  );
}
