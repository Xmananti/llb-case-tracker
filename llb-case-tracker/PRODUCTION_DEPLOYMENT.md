...
**How to set up GCS:** See project root `GCS_SETUP.md`. Create a GCS bucket, create a service account with Storage Object Admin, and set the JSON key as `GCS_SERVICE_ACCOUNT_KEY` (or use `GOOGLE_APPLICATION_CREDENTIALS`).
