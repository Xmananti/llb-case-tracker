        ...
        <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-slate-50 to-slate-100 p-4">
            <div className="w-full max-w-md rounded-lg bg-white p-4 sm:p-6 lg:p-8 shadow-xl border-t-4 border-amber-500">
                <div className="text-center mb-4 sm:mb-6">
                    ...
                    <h2 className="text-xl sm:text-2xl font-bold text-slate-900">Sign in</h2>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-3 sm:space-y-4">
                    ...
                    <p className="text-center text-xs sm:text-sm text-slate-600">
                        <Link href="/forgot-password" className="text-amber-600 hover:text-amber-700 font-medium">Forgot password?</Link>
                    </p>
                </form>
